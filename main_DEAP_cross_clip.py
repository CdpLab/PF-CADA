...
std_accuracy = np.std(acc_list)  # 计算标准偏差
...
with open('exercise/DEAP_CrossClip_v_results.txt', 'w') as f:
...
np.savetxt('exercise/DEAP_CrossClip_v_confusion_matrix.csv', global_cm, delimiter=',', fmt='%d')
